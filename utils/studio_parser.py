...
def parse_and_store():
	data = open('/home/mithu/Downloads/xml/Guindy.xml')
	...
	for every_shop in shops:
		...
		if 'women' in name.lower():
			kind = 2
		file_name = '/home/mithu/Pictures/thumbs/'+random.choice(os.listdir("/home/mithu/Pictures/thumbs"))
		imgz = open(file_name)
		img = File(imgz)
		try:
