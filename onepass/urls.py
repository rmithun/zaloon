...
urlpatterns = patterns('',
    ...
    url(r'landing/^$', TemplateView.as_view(template_name='user_accounts/index.html'), name="landing"),
    url(r'^register/(?P<backend>[^/]+)/$',
        uac_view.register_by_access_token),
    url(r'^app/$',TemplateView.as_view(template_name='user_accounts/default.html'),name = 'default'),
